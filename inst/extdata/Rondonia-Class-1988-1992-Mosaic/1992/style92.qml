...
<qgis minScale="1e+08" styleCategories="AllStyleCategories" version="3.22.4-Białowieża" hasScaleBasedVisibilityFlag="0" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer band="1" alphaBand="-1" opacity="1" type="paletted" nodataColor="">
      ...
      <colorPalette>
        <paletteEntry value="8" color="#0d05e1" label="NoCFlass" alpha="0"/>
        <paletteEntry value="9" color="#fbf307" label="Deforest91" alpha="255"/>
        <paletteEntry value="10" color="#f60004" label="Incremente92" alpha="255"/>
        <paletteEntry value="12" color="#0c6d05" label="NoDeforest" alpha="255"/>
