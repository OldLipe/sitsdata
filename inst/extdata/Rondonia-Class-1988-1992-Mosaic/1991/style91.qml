...
<qgis minScale="1e+08" styleCategories="AllStyleCategories" version="3.22.4-Białowieża" hasScaleBasedVisibilityFlag="0" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer band="1" alphaBand="-1" opacity="1" type="paletted" nodataColor="">
      ...
      <colorPalette>
        <paletteEntry value="8" color="#dc1010" label="NoClass" alpha="0"/>
        <paletteEntry value="9" color="#fbf307" label="Deforest90" alpha="255"/>
        <paletteEntry value="10" color="#fb0004" label="Increment91" alpha="255"/>
